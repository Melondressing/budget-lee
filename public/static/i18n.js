...
const translations = {
  ko: {
    ...
    'wallet.join_by_code': '공유 코드로 참여',
    'wallet.invite_code': '공유 코드',
    'wallet.invite_code_placeholder': '예: A1B2C3',
    'wallet.enter_invite_code': '공유 코드를 입력해주세요.',
    'wallet.nickname_optional': '닉네임 (선택)',
    'wallet.join_success': '공유지갑에 참여했습니다.',
    'wallet.join_error': '공유지갑 참여 중 오류가 발생했습니다.',
    'wallet.copy_code': '코드 복사',
    'wallet.code_copied': '코드를 복사했습니다.',
    'wallet.accounts': '계좌 목록',
    'wallet.account_count': '활성 계좌 수',
    'wallet.member_count': '참여 인원',
    'wallet.account_type': '계좌 유형',
    'wallet.account': '거래 계좌',
    ...
    'wallet.new_transaction': '거래 추가',
    'wallet.transaction_type': '거래 유형',
    'wallet.tx_type_withdraw': '지출 (출금)',
    'wallet.tx_type_deposit': '입금',
    'wallet.transaction_date': '거래 날짜',
    'wallet.transaction_error': '공유지갑 거래 등록 중 오류가 발생했습니다.',
  ...
  en: {
    ...
    'wallet.join_wallet': 'Join by Code',
    ...
    'wallet.join_by_code': 'Join with Invite Code',
    'wallet.invite_code': 'Invite Code',
    'wallet.invite_code_placeholder': 'e.g. A1B2C3',
    'wallet.enter_invite_code': 'Please enter an invite code.',
    'wallet.nickname_optional': 'Nickname (Optional)',
    'wallet.join_success': 'Joined the shared wallet.',
    'wallet.join_error': 'Failed to join the shared wallet.',
    'wallet.copy_code': 'Copy Code',
    'wallet.code_copied': 'Code copied.',
    'wallet.accounts': 'Accounts',
    'wallet.account_count': 'Active Accounts',
    'wallet.member_count': 'Members',
    'wallet.account_type': 'Account Type',
    'wallet.account': 'Transaction Account',
    ...
    'wallet.new_transaction': 'Add Transaction',
    'wallet.transaction_type': 'Transaction Type',
    'wallet.tx_type_withdraw': 'Withdrawal (Expense)',
    'wallet.tx_type_deposit': 'Deposit (Income)',
    'wallet.transaction_date': 'Transaction Date',
    'wallet.transaction_error': 'Failed to create shared wallet transaction.',
